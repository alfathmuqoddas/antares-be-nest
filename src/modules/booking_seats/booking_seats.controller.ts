...
export class BookingSeatsController {
  ...
  @Get('booked/:showtimeId')
  findAllBookedSeatsByShowtimeId(@Param('showtimeId') showtimeId: string) {
    return this.bookingSeatsService.findAllBookedSeatsByShowtimeId(showtimeId);
  }
